...
def gridBuilder(stringONumbers):
    # Make the  20x20 grid by using nested lists as x,y coordinates
    coords = [[], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []]

    workingList = stringONumbers.split()
...
def greatestProduct(data):
    ...
    greatestProduct = 0
    for number in prodList:
        if number > greatestProduct:
            greatestProduct = number

    return greatestProduct;

print(greatestProduct(testData))
